...
public class FdtTwin0003 extends EntityTranslator {

    private static final Logger log = LoggerFactory.getLogger(FdtTwin0003.class);

    public FdtTwin0003(String modelType) {
    }
