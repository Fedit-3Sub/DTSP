...
public class FdtTwin0008 extends EntityTranslator {

    private static final Logger log = LoggerFactory.getLogger(FdtTwin0008.class);

    public FdtTwin0008(String modelType) {
    }
