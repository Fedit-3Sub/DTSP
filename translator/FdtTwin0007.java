...
public class FdtTwin0007 extends EntityTranslator {

    private static final Logger log = LoggerFactory.getLogger(FdtTwin0007.class);

    public FdtTwin0007(String modelType) {
    }
