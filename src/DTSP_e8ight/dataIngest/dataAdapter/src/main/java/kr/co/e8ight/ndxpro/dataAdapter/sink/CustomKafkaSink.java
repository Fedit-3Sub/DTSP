...
public class CustomKafkaSink extends AbstractSink implements Configurable, BatchSizeSupported {

    private static final Logger logger = LoggerFactory.getLogger(org.apache.flume.sink.kafka.KafkaSink.class);
        ...
        try {
            ...
            for (; processedEvents < batchSize; processedEvents += 1) {
                ...
                try {
                    ...
                    kafkaFutures.add(producer.send(record, new kr.co.e8ight.ndxpro.dataAdapter.sink.SinkCallback(startTime)));
            ...
            if (processedEvents > 0) {
                ...
                for (Future<RecordMetadata> future : kafkaFutures) {
                    future.get();
                    signalProcessor.sendSignal("sink",agentId);
                }
...
class SinkCallback implements Callback {
    private static final Logger logger = LoggerFactory.getLogger(kr.co.e8ight.ndxpro.dataAdapter.sink.SinkCallback.class);
