...
@Setter
@Builder
@Schema(description = "측정된 전열 에너지")
public class ElectricHeatMeasurement {
    ...
    @Schema(description = "재실 추정 여부(유/무)")
    private String vacancyPredictionStateByRoom;

    @Schema(description = "소비 전력")
    private String powerConsumption;

    @Schema(description = "대기 전력")
    private String standbyPower;

    @Schema(description = "재실 여부")
